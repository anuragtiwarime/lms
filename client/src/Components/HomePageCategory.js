...
const HomePageCategory = ({ iconName }) => {
  return (
    <div className="w-60 py-8 flex flex-col items-center justify-center gap-2 rounded-md bg-gray-800 text-white shadow-[0_0_10px_black] cursor-pointer transition-all ease-in-out duration-300 hover:-translate-y-4">
