    ...
    <div className="text-white w-80 border rounded-lg shadow-[0_0_10px_white] cursor-pointer transition-all ease-in-out duration-300 hover:scale-[1.04]">
      ...
      <div className="p-3 space-y-1 text-white">
        ...
        <p className="line-clamp-3">
          ...
          repellendus officia est quod eveniet debitis nostrum dicta laboriosam
          suscipit nisi.
        </p>
        ...
        <p className="font-semibold">
          <span className="text-yellow-500 font-bold">Total Lectures : </span>20
        </p>
        <p className="font-semibold">
          <span className="text-yellow-500 font-bold">Instructor : </span>Harvi
        </p>
      </div>
    </div>
  );
